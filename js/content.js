var contentData =
{
	"vertices-and-edges": {
		...
		"content-title": "顶点和边缘（Vertices and Edges）",

		"theory-content":		"<div><span style: 'whitespace: nowrap'>图是顶点（vertices）的集合<\/span><span style: 'whitespace: nowrap'><svg width=30 height=30 xml:space='preserve' style='margin-left: 4; margin-right: 0 position:relative'><g><circle cx='15' cy='15' r='10' fill='#1f77b4'/></g></svg><\/span><span style: 'whitespace: nowrap'><svg width=30 height=30 xml:space='preserve' style='margin-left: 0; margin-right: 0; position:relative'><g><circle cx='15' cy='15' r='10' fill='#ff7f0e'/></g></svg><\/span><span style: 'whitespace: nowrap'><svg width=30 height=30 xml:space='preserve' style='margin-left: 0; margin-right: 4; position:relative'><g><circle cx='15' cy='15' r='10' fill='#2ca02c'/></g></svg><\/span><span style: 'whitespace: nowrap'>通过边缘（edges）相互连接<\/span><span style: 'whitespace: nowrap'><svg width=30 height=30 xml:space='preserve' style='margin-left: 4; margin-right: 0 position:relative'><g><line x1='5' y1='25' x2='25' y2='5' stroke='#888' stroke-width='2px' stroke-linecap='round' stroke-linejoin='round'/></g></svg><\/span><span style: 'whitespace: nowrap'><svg width=30 height=30 xml:space='preserve' style='margin-left: 0; margin-right: 0; position:relative'><g><line x1='5' y1='25' x2='25' y2='5' stroke='#888' stroke-width='2px' stroke-linecap='round' stroke-linejoin='round'/></g></svg><\/span><span style: 'whitespace: nowrap'><svg width=30 height=30 xml:space='preserve' style='margin-left: 0; margin-right: 0; position:relative'><g><line x1='5' y1='25' x2='25' y2='5' stroke='#888' stroke-width='2px' stroke-linecap='round' stroke-linejoin='round'/></g></svg><\/span><span style: 'whitespace: nowrap'>.  我们用\\(V\\) 表示所有顶点的集合，用\\(E\\)表示所有边缘集合。<\/p><p>懂了吗? 简单来说: 图有两个组成部分 -  <b>顶点集合<\/b> \\(V\\) 与 <b>边缘集合<\/b> \\(E\\)。边缘是用来连接顶点的东西。<\/p><p>如果边缘连接两个顶点\\(v_1\\) 和 \\(v_2\\), 那么用\\(v_1v_2\\)来表示边缘, 和\\(v_2v_1\\)等同。<\/p><p>如果两个顶点通过边缘连接，则称它们为<b>相邻（adjacent）<\/b>。<\/p><p>现在阅读下面的说明并创建自己的图。你会在图的区域下方看到集合\\(V\\) 和 \\(E\\) 。开始玩几局，让自己熟悉这些符号。<\/span><\/div>",
